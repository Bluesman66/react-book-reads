  ...
  render() {
    return (
      <div className="app">
        ...
        <Route
          path="/search"
          render={() => <SearchPage handleBookStatusUpdate={this.handleBookStatusUpdate} books={this.state.bookList} />}
        />
        ...
        <Route
          path="/"
          exact={true}
          render={() => <Home handleBookStatusUpdate={this.handleBookStatusUpdate} books={this.state.bookList} />}
        />
      </div>
    );
  }
